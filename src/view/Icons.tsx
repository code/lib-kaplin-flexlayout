...
export const GripIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style={style} fill="var(--color-icon)">
...
export const SettingsIcon = (props: React.SVGProps<SVGSVGElement>) => {
    return (
        <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" style={style} {...props} viewBox="0 0 24 24" fill="var(--color-icon)">
            <g>
