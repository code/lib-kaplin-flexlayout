...
const COLOR_VARS: IColorDef[] = [
    { group: "Core", label: "Text", varName: "--fl-color-text" },
    { group: "Core", label: "Background", varName: "--fl-color-background" },
    { group: "Core", label: "Base", varName: "--fl-color-base" },
    { group: "Core", label: "Color 1", varName: "--fl-color-1" },
    { group: "Core", label: "Color 2", varName: "--fl-color-2" },
    { group: "Core", label: "Color 3", varName: "--fl-color-3" },
    { group: "Core", label: "Color 4", varName: "--fl-color-4" },
    { group: "Core", label: "Color 5", varName: "--fl-color-5" },
    { group: "Core", label: "Color 6", varName: "--fl-color-6" },
    { group: "Core", label: "Drag 1", varName: "--fl-color-drag1" },
    { group: "Core", label: "Drag 2", varName: "--fl-color-drag2" },
    { group: "Core", label: "Drag 1 background", varName: "--fl-color-drag1-background" },
    { group: "Core", label: "Drag 2 background", varName: "--fl-color-drag2-background" },
    { group: "Tabs", label: "Selected", varName: "--fl-color-tab-selected" },
    { group: "Tabs", label: "Selected background", varName: "--fl-color-tab-selected-background" },
    { group: "Tabs", label: "Unselected", varName: "--fl-color-tab-unselected" },
    { group: "Tabs", label: "Unselected background", varName: "--fl-color-tab-unselected-background" },
    { group: "Tabs", label: "Rename textbox text", varName: "--fl-color-tab-textbox" },
    { group: "Tabs", label: "Rename textbox background", varName: "--fl-color-tab-textbox-background" },
    { group: "Tabset", label: "Background", varName: "--fl-color-tabset-background" },
    { group: "Tabset", label: "Selected background", varName: "--fl-color-tabset-background-selected" },
    { group: "Tabset", label: "Maximized background", varName: "--fl-color-tabset-background-maximized" },
    { group: "Tabset", label: "Divider line", varName: "--fl-color-tabset-divider-line" },
    { group: "Border", label: "Selected", varName: "--fl-color-border-tab-selected" },
    { group: "Border", label: "Selected background", varName: "--fl-color-border-tab-selected-background" },
    { group: "Border", label: "Unselected", varName: "--fl-color-border-tab-unselected" },
    { group: "Border", label: "Unselected background", varName: "--fl-color-border-tab-unselected-background" },
    { group: "Border", label: "Background", varName: "--fl-color-border-background" },
    { group: "Border", label: "Divider line", varName: "--fl-color-border-divider-line" },
    { group: "Border", label: "Tab content", varName: "--fl-color-border-tab-content" },
    { group: "Border", label: "Text", varName: "--fl-color-border" },
    { group: "Splitter", label: "Splitter", varName: "--fl-color-splitter" },
    { group: "Splitter", label: "Hover", varName: "--fl-color-splitter-hover" },
    { group: "Splitter", label: "Drag", varName: "--fl-color-splitter-drag" },
    { group: "Splitter", label: "Handle", varName: "--fl-color-splitter-handle" },
    { group: "Menu", label: "Border", varName: "--fl-color-popup-border" },
    { group: "Menu", label: "Unselected", varName: "--fl-color-popup-unselected" },
    { group: "Menu", label: "Unselected background", varName: "--fl-color-popup-unselected-background" },
    { group: "Menu", label: "Selected", varName: "--fl-color-popup-selected" },
    { group: "Menu", label: "Selected background", varName: "--fl-color-popup-selected-background" },
    { group: "Drag Rect", label: "Border", varName: "--fl-color-drag-rect-border" },
    { group: "Drag Rect", label: "Background", varName: "--fl-color-drag-rect-background" },
    { group: "Drag Rect", label: "Text", varName: "--fl-color-drag-rect" },
    { group: "Misc", label: "Icon", varName: "--fl-color-icon" },
    { group: "Misc", label: "Overflow", varName: "--fl-color-overflow" },
    { group: "Misc", label: "Focus", varName: "--fl-color-focus" },
    { group: "Misc", label: "Toolbar button hover", varName: "--fl-color-toolbar-button-hover" },
    { group: "Misc", label: "Edge marker", varName: "--fl-color-edge-marker" },
    { group: "Misc", label: "Edge icon", varName: "--fl-color-edge-icon" },
    { group: "Tab Group", label: "Pill text", varName: "--fl-color-tabgroup-pill-text" },
    { group: "Tab Group", label: "Default color", varName: "--fl-color-tabgroup-default" },
];

const METRIC_VARS: IMetricDef[] = [
    { label: "Splitter size", varName: "--fl-splitter-size", min: 1, max: 20, step: 1, unit: "px" },
    { label: "Splitter active size", varName: "--fl-splitter-active-size", min: 1, max: 20, step: 1, unit: "px" },
    { label: "Tab button radius", varName: "--fl-tab-button-radius", min: 0, max: 30, step: 1, unit: "px" },
    { label: "Border button radius", varName: "--fl-border-button-radius", min: 0, max: 30, step: 1, unit: "px" },
    { label: "Tabgroup pill radius", varName: "--fl-tabgroup-pill-radius", min: 0, max: 30, step: 1, unit: "px" },
    { label: "Mini scroll indicator size", varName: "--fl-size-mini-scroll-indicator", min: 2, max: 10, step: 1, unit: "px" },
];
...
const toGlobalVar = (varName: string): string => varName.replace(/^--fl-/, "--flexlayout-");
